...
namespace FSDP.UI.MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase resumeFile/*, HttpPostedFileBase imageFile*/)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
                var result = await UserManager.CreateAsync(user, model.Password); //what creates record in ASPNetUsers
                ...
                //newUser.PhotoFileName = model.PhotoFileName;
                newUser.ResumeFilename = model.ResumeFileName;
